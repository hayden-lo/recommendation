...
class DSSM(tf.keras.models.Model):
    def __init__(self, param_dict, *args, **kwargs):
        ...
        self.user_dense_layer1 = DenseLayer(256, self.act_fun, name="user_dense1", reg_fun=self.reg_fun)
        self.user_dense_layer2 = DenseLayer(128, self.act_fun, name="user_dense2", reg_fun=self.reg_fun)
        self.item_dense_layer1 = DenseLayer(256, self.act_fun, name="item_dense1", reg_fun=self.reg_fun)
        self.item_dense_layer2 = DenseLayer(128, self.act_fun, name="item_dense2", reg_fun=self.reg_fun)
    ...
    def get_config(self):
        ...
        config.update({"feature_size": self.feature_size, "emb_size": self.emb_size, "act_fun": self.act_fun,
                       "reg_fun": self.reg_fun, "user_feats_size": self.user_feats_size,
