...
from models.rec_item2vec.model_item2vec_gensim import Item2VecGensim
from models.rec_item2vec.iter_constructor import IterConstructor
from models.rec_item2vec.get_train_data import produce_train_data
...
if __name__ == '__main__':
    ...
    params_dict = {"act_file": "data/movieLens1m_201809/ratings.csv",  # action logs file
                   "act_seq_file": "rec_item2vec/vecData/act_seq.txt",  # action sequence file
                   ...
                   "gensim_model_file": "rec_item2vec/gensim_w2v_model",  # gensim output word2vec model file
                   "gensim_vectors_file": "rec_item2vec/vecData/gensim_vectors.txt",  # gensim output vectors file
